  ...
  },
  {
    languageOptions: {
      ...
      parserOptions: {
        ...
        project: [
          "./packages/pivot-search/tsconfig.json",
          "./packages/rollup-config/tsconfig.json",
          "./packages/types/tsconfig.json",
          "./packages/utils/tsconfig.json",
          "./packages/ui/calendar/tsconfig.json",
          "./packages/ui/chat/tsconfig.json",
          "./packages/ui/input/tsconfig.json",
          "./packages/ui/resume/tsconfig.json",
