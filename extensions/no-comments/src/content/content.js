(function() {
            ...
            if (typeof browser !== 'undefined' && !window.chrome) {
              ...
              function isCodePage() {
                              const found = document.querySelector('.js-file-content, .blob-wrapper, .highlight, textarea[data-testid="read-only-cursor-text-area"]') !== null;
                                    ...
                                    console.log('❌ Not on code page, skipping textarea processing');
                                          return;
                                              ...
                                              textareas.forEach(textarea => {
                                                                ...
                                                                const textareaId = textarea.id || `textarea-${Date.now()}-${Math.random()}`;
              ...
              function showComments() {
                              ...
                              const textareas = document.querySelectorAll('textarea[data-comment-processed]');
                              console.log('👁️ Found textareas to restore:', textareas.length);
                              textareas.forEach(textarea => {
                                                const originalText = originalContent.get(textarea.id);
                                                console.log('👁️ Restoring textarea:', textarea.id, 'has original:', !!originalText);
                                                if (originalText) {
