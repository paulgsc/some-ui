...
export type AddWhitelistMsg    = { type: "ADD_WHITELIST";     channelId: string; channelName: string }
...
export type EnabledChangedBroadcast  = { type: "ENABLED_CHANGED";  enabled: boolean }
export type ChannelWhitelistedBroadcast = { type: "CHANNEL_WHITELISTED"; channelId: string }

export type BgBroadcast =
  | EnabledChangedBroadcast
  | ChannelWhitelistedBroadcast
