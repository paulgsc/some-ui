/**
 * some-conveyor extension E2E configuration.
 *
 * Key decisions:
 *
 ...
 *      extensions without a separate web-ext process + CDP bridge. The conveyor
 *      logic (shadow DOM init, WASM graceful failure, cube rendering) is
 *      browser-agnostic; Chromium covers the critical paths.
 *
