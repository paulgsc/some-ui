...
export function createShadowScopeTheming(
  ...
  return {
    ...
    observe(): void {
      ...
      // mode change only: NOT on pagehide (content.ts's pagehide handler
      // does not reach this poll), and NOT when the tab goes hidden. See
      // that file's exemption for why this says so plainly.
