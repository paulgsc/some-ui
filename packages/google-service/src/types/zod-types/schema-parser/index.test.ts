...
export const OAuth2UniversalSchemaWithCalcomBackwardCompatibility =
  OAuth2UniversalSchema.extend({
    /**
...
export const OAuth2TokenResponseInDbWhenExistsSchema =
  OAuth2UniversalSchemaWithCalcomBackwardCompatibility
export const OAuth2TokenResponseInDbSchema =
  OAuth2UniversalSchemaWithCalcomBackwardCompatibility.nullable()
