...
export default defineConfig([
  ...someUIEslint,
  {
    // This package ships raw TS source (package.json "exports" point
    // straight at src/index.ts and src/*.ts - there's no build step of its
    // own). Every consumer's bundler processes these files as part of its
    // OWN module graph, so a self-alias would need every consumer's
