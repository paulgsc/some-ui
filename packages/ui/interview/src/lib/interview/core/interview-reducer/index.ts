...
export const interviewReducer = (
  ...
  switch (event.type) {
    ...
    // eslint-disable-next-line switch-lint/require-fail-fast-default -- reducer intentionally ignores events irrelevant to the current phase and returns state unchanged
    default: {
      return state
    }
  }
