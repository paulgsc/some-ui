...
export const lexicographicallySmallestValidSequence: Exercise = {
  ...
  steps: [
    ...
    step({
      ...
      transferFrom: "lc3302-01-length-feasibility",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-03-reverse-cursors",
      obligation:
    ...
    step({
      ...
      concepts: [CONCEPT_IDS.suffixCertificate],
      transferFrom: "lc3302-04-reverse-progress",
    ...
    step({
      ...
      transferFrom: "lc3302-06-advance-suffix",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-07-forward-state",
    ...
    step({
      ...
      transferFrom: "lc3302-08-mismatch-budget",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-09-answer-capacity",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-10-forward-domain",
      obligation:
    ...
    step({
      ...
      concepts: [CONCEPT_IDS.strictIndexOrdering],
      transferFrom: "lc3302-11-exact-match-priority",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-12-advance-target",
      obligation:
    ...
    step({
      ...
      concepts: [CONCEPT_IDS.oneMismatchBudget],
      transferFrom: "lc3302-15-strict-boundary",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-16-commit-change",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-17-source-progress",
    ...
    step({
      ...
      transferFrom: "lc3302-20-safe-change-predicate",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-21-earliest-safe-choice",
      obligation:
    ...
    step({
      ...
      transferFrom: "lc3302-22-linear-bound",
      obligation:
