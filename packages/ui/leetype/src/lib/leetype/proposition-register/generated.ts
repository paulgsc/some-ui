...
> = {
  ...
  "CW-P2": {
    ...
    statement:
      'A body enclosed in a repetition contributes the product of the repetition count and the body\'s cost: $T("Loop"(r, G)) = r dot T(G)$.',
    status: "active",
  },
  "CW-P3": {
    id: "CW-P3",
    ...
    statement:
      "A finite sum of terms in one input dimension is $Theta$ of its largest: $sum_j n^(a_j) = Theta(n^(max_j a_j))$.",
    status: "active",
  },
  "CW-P4": {
    id: "CW-P4",
  ...
  "CW-P5": {
    ...
    statement:
      "Replacing a repeated linear search inside a loop with one preprocessing pass plus expected constant-time membership rewrites $n m$ into $n + m$ expected, at $Theta(m)$ additional space.",
    status: "active",
  },
  "CW-P6": {
    id: "CW-P6",
  ...
  "CW-P7": {
    ...
    statement:
      "A comparison over all pairs that is answerable from adjacency in sorted order rewrites $n^2$ into $n log n + n = Theta(n log n)$.",
    status: "active",
  },
  "CW-P8": {
    id: "CW-P8",
  ...
  "CW-P9": {
    ...
    statement:
      "$sum_(i<n) (n - i) = n(n-1)/2 = Theta(n^2)$. Iterating only the upper triangle halves the work and does not change the class.",
    status: "active",
  },
  "CW-P10": {
    id: "CW-P10",
  ...
  "CW-P11": {
    ...
    statement:
      "A rewrite confined to nodes off every dominant path cannot change $Theta(T)$, however much code it touches. (Prop. 5.1.)",
    status: "active",
  },
  "CW-P12": {
    id: "CW-P12",
    ...
    statement:
      "Nesting depth $k$ implies $O(n^k)$ only when every level contributes $Theta(n)$. In general the exponent is the maximum over root-to-leaf paths of the sum of that path's loop exponents. (Cor. 2.1, Rem. 2.1.)",
    status: "active",
  },
  "CW-P13": {
    id: "CW-P13",
  ...
  "CW-P14": {
    ...
    statement:
      "$n + m$ and $n m$ are distinct, and neither is $Theta(n^2)$ unless a constraint relates $m$ to $n$. A cost expression over two dimensions evaluated as though there were one is the most common source of a wrong admissibility verdict in practice.",
    status: "active",
  },
  "CW-P15": {
    id: "CW-P15",
