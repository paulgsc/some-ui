...
export const StudyScene = () => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-gray-100 p-6">
      <div className="relative w-full max-w-2xl h-96 bg-blue-50 rounded-lg shadow-lg overflow-hidden">
        {/* Background */}
          ...
          {[...Array(12)].map((_, i) => (
            <div
              ...
              style={{
                ...
                width: '5%',
                height: '70%',
                backgroundColor: colors.shelfBooks[i % colors.shelfBooks.length],
        ...
        >
          <pre style={{ lineHeight: '1.4' }}>{displayText}</pre> {/* Increased line height */}
          <div
            className="absolute"
            style={{
        ...
        {/* Open book */}
        <div className="absolute" style={{ left: '25%', bottom: '25%', width: '13%', height: '1%', backgroundColor: '#999' }} />
        <div
          className="absolute"
          style={{
            left: '20%',
        ...
        <div
          className="absolute lamp-light" // Added lamp-light class
          style={{
            right: '16%',
            bottom: '37%',
            width: '6%',
        ...
        <div
          className="absolute student-head" // Added student-head class
          style={{
            left: '50%',
            bottom: '47%',
        ...
        {thoughtBubbleVisible && (
          <>
            {/* Main thought bubble */}
            <div
              className="absolute thought-bubble" // Added thought-bubble class
              style={{
                left: '60%',
                bottom: '60%',
            ...
            >
              <div className="text-md font-bold text-center">💡</div> {/* Larger icon */}
            </div>
        ...
        <div
          className="absolute student-torso" // Added student-torso class
          style={{
            left: '50%',
            bottom: '15%',
        ...
        <div
          className="absolute student-arm-left" // Added student-arm-left
          style={{
            left: '36%',
            bottom: '30%',
        ...
        <div
          className="absolute student-arm-right"  //Added student-arm-right
          style={{
            right: '36%',
            bottom: '30%',
            width: '13%',
