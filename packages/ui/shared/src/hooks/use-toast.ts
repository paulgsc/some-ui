...
type Actions = "ADD_TOAST" | "UPDATE_TOAST" | "DISMISS_TOAST" | "REMOVE_TOAST"
...
type ActionType = { [K in Actions]: K }
...
type ToastReturnOptions = {
  id: string
  dismiss: () => void
  update: (props: ToasterToast) => void
}

function toast({ ...props }: Toast): ToastReturnOptions {
  const id = genId()
