...
export const AnimatedSteps: FC<AnimatedStepsProps> = ({}) => {
  return (
    <section className="flex min-h-screen items-center justify-center border border-red-100">
      ...
      >
        <li className="animate-slide-right w-full rounded-lg bg-blue-400 p-4 text-center text-white"></li>
        <li className="animate-slide-left w-full rounded-lg bg-red-400 p-4 text-center text-white"></li>
        <li className="animate-slide-right w-full rounded-lg bg-green-400 p-4 text-center text-white"></li>
      </ul>
    </section>
  )
}
